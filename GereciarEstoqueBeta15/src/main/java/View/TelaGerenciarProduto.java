...
public class TelaGerenciarProduto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tableProdutos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "ID_CATEGORIA", "NOME", "QUANTIDADE", "PREÇO", "DESCRIÇÃO", "NOME CATEGORIA"
            }
        ) {
...
// salva na tabela categoria
   ...
   private void listarProdutos(){
        ...
        ArrayList<ProdutoComCategoriaDTO> lista = objProdutosDAO.listarProdutosComCategoria();
   ...
   private void carregarCampos(){
      ...
      txtNomeProduto.setText(tableProdutos.getModel().getValueAt(setar, 2).toString());
      txtQuantidadeProduto.setText(tableProdutos.getModel().getValueAt(setar, 3).toString());
      txtPrecoProduto.setText(tableProdutos.getModel().getValueAt(setar, 4).toString());
      txtDescricaoProduto.setText(tableProdutos.getModel().getValueAt(setar, 5).toString());
      txtCategoria.setText(tableProdutos.getModel().getValueAt(setar, 6).toString());
   }
...
private void atualizar(){
    ...
    if (txtid.getText().trim().isEmpty() || txtCat.getText().trim().isEmpty() ||
...
private void Excluir(){
    if (txtid.getText().isEmpty() || txtCat.getText().isEmpty()) {
