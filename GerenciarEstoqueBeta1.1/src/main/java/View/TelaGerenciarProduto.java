...
// Divide a categoria e pega o ID (supondo que o formato seja "1-Eletrônicos")
        String[] categoriaIdSplit = categoria.split("-", 0);

// Conversões com tratamento de erro
        try {
            int quantidade = Integer.parseInt(quantidadeStr);
            int preco = Integer.parseInt(precoStr);
            int categoriaId = Integer.parseInt(categoriaIdSplit[0]);
            ...
            objprodutosdto.setCategoria_id(categoriaId);
           objprodutosdto.setDescricao_produto(descricao);

    // continue com a lógica do seu programa
